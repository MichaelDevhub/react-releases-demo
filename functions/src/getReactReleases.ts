...
const FETCH_REACT_RELEASES_URL = "https://api.github.com/repos/facebook/react/releases";
...
const filterReleaseData = (releases: IReleaseData[], searchKey: string): IReleaseData[] =>
  releases.filter((release: IReleaseData) =>
